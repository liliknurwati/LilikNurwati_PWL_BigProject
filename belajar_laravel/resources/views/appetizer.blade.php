...
<div class="jumbotron jumbotron-fluid" style="background-image: url(img/bigProject/salad.png); background-size: cover; height:250px; color:#ffffff;">
  <div class="container text-center">
  <br><br><br><br><br>
    <h1 class="display-4">APPETIZER</h1>
    <p class="lead"></p>
  </div>
</div>
<div class="container">
...
<div class="card" style="width: 18rem;">
  <img src="{{ url('/UploadsMenu/'.$a->filenama) }}" class="card-img-top" width="200px" height="200px">
  <div class="card-body">
    <h5 class="card-title">{{$a->nama}}</h5>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">{{$a->harga}}</li>
