...
<html lang="en">
  <head>
    ...
    <title>Add makanan dan minuman</title>
  </head>
  <body>
  ...
  <div class="cd" style="background-image:linear-gradient(#000046, black)">
  <div class="container text-center">
  <br><br><br>
  <h1 style="color: white;">ADD MENU</h1>
  </div>
<style>
...
<br>
    <form action="/addmenu/proses" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
            ...
            <div class="form-group">
                <label>Photo</label>
            <input type="file" name= "filenama" class="form-control border-0">  
            </div>
            <div class="form-group">
