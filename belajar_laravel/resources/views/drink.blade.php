...
<div class="jumbotron jumbotron-fluid" style="background-image: url(img/bigProject/bm.jpg); background-size: cover; height:250px; color:#ffffff;">
  ...
  <br><br><br><br><br>
    <h1 class="display-4">Cool Drinks</h1>
    <p class="lead"></p>
  </div>
</div>
<div class="container">
...
<div class="card" style="width: 18rem;">
  <img src="{{ url('/UploadsMenu/'.$c->filenama) }}" class="card-img-top" width="200px" height="200px">
  <div class="card-body">
    <h5 class="card-title">{{$c->nama}}</h5>
  </div>
  <ul class="list-group list-group-flush">
    <li class="list-group-item">Harga : {{$c->harga}}</li>
    <li class="list-group-item">Stock : {{$c->stock}}</li>
  </ul>
</div>
</div>
@endforeach
