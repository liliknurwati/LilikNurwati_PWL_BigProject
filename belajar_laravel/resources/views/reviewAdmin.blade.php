...
<html lang="en">
  ...
  <div class="bx" style="background-color:#D9DDDC;">
  <br><br><br>
  <h1 style="text-align:center;">REVIEWS PELANGGAN</h1>
  ...
  <div class="card-header" style="background-color:#3E424B; color:white;">
    ID: {{$r->id}} &nbsp; Nama: {{$r->nama}}
    <a href="/reviewAdmin/{{$r->id}}"><button type="button" style="background-color:red; border:none; color:white; font-family:sans-serif; float:right;">Delete</button></a>
  </div>
